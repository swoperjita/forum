            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Email verification checkbox right above the register button -->
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                {{-- <input type="checkbox" id="anonymous" name="anonymous" class="form-check-input">
                                <label for="anonymous" class="form-check-label">Email verification</label> --}}
                            </div>
                        </div>
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
